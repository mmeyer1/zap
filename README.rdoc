...
Next Goal: 
Add a persistent navbar/some AJAX for basic actions (particularly on the unit index page). 

Future:
Create the Paint resource, Paint will be an open source library of known paint colors, I'd like to seed it somehow with data
on the basic GW/Vallejo/P3 ranges but leave functionality for users to add new colors. Will be associated to units through a join 
